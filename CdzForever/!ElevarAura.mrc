on *:text:!Elevar Aura Máxima*:#: {
  if ($nick !ison #cdzforever) {
    .msg $nick 1,1|14,14|15,1 Você não está no 0CdzForever15 para ter acesso ao bot. 14,14|1,1|
    /closemsg $nick
  }
  if ($nick ison #cdzforever) {
    if ($readini users/ $+ $nick $+ .ini $Nick Nick == $null) {
      .msg $nick 1,1|14,14|15,1 Você não está0 Cadastrado. 14,14|1,1| 
      /closemsg $nick
    }
    if ($Readini users/ $+ $nick $+ .ini $Nick Nick != $null) {
      set %Cosmoki $readini users/ $+ $nick $+ .ini $nick Cosmo
      set %msg $chan
      set %aura Máxima
      if ( %Cosmoki >= 9000000 ) { 
        set %aff $calc(%Cosmoki * 700)
      .msg %msg 1,1|14,14|0,1 $nick 15Seu Cosmo elevado a Aura7 %aura 15é de:0  $+ $replace($bytes(%aff,b),$chr(44),.) $+  14,14|1,1| }
      if ( %Cosmoki < 7200000 ) { 
        .msg %msg 1,1|14,14|0,1 $nick 15Você não resistiria elevar seu Cosmo a Aura7 %aura 14,14|1,1|
      }
      if ( %Cosmoki < 9000000 ) && (%cosmoki > 7200000 ) { 
        if ( %Cosmoki < 9000000 ) && ( %Cosmoki >= 8900000 ) { 
          set %danos 10%
          set %aff $calc(%Cosmoki * 200)
        .msg %msg 1,1|14,14|0,1 $nick 15Seu Cosmo elevado a Aura7 %aura 15Com danos de 09 $+ %danos $+ 15 é de: 0  $+ $replace($bytes(%aff,b),$chr(44),.) $+  14,14|1,1| }
  ...
  if ($nick ison #cdzforever) {
    ...
    if ($Readini users/ $+ $nick $+ .ini $Nick Nick != $null) {
      ...
      if ( %Cosmoki < 50000000 ) && (%cosmoki >= 15000000 ) { 
        ...
        .msg %msg 1,1|14,14|0,1 $nick 15Seu Cosmo elevado à Aura7 %aura 15Com danos de 09 $+ %danos $+ 15 é de: 0  $+ $replace($bytes(%aff,b),$chr(44),.) $+  14,14|1,1| }
